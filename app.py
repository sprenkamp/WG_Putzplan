...
# Parameter
start = pd.date_range(start="2025-05-05", end=get_future_date("Monday"), freq="W-MON")
end = pd.date_range(start="2025-05-11", end=get_future_date("Sunday"), freq="W")
people = ["Melissa", "Kilian", "Cédric", "Janine", "Melanie"]
cycles = len(end)
